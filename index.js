...
function takeANumberTwo() {
  customerCount++
  console.log (`Hello, your number is ${customerCount}`)
}
takeANumberTwo()
takeANumberTwo()
takeANumberTwo()
...
function nowServing(currentLine) {
  if (currentLine.length > 0) { // if () is true and there are people in line do the following:
    var x = currentLine [0] // Assigns the first person in line to the variable x in order to be called when returning
    currentLine.splice(0,1) // at index 0, remove 1 the first person in line
